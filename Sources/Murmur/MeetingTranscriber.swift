...
/// not a real name. Murmur has no source for real participant names
...
final class MeetingTranscriber {
    ...
    /// "Fixes made by Murmur" tally in Insights that normal dictation does
    ...
    /// ASR output only, with none of Murmur's own accuracy pipeline
